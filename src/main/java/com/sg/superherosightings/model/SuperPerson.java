...
public class SuperPerson {
    ...
    @NotEmpty(message = "You must supply a value for the superperson name.")
    @Length(max = 45, message = "Superperson name must be no more than 45 characters in length.")
    private String name;
    @Length(max = 100, message = "Superperson description must be no more than 100 characters in length.")
    private String description;
    @NotEmpty(message = "You must supply a value for the superperson's superpower.")
    @Length(max = 45, message = "Superperson's superpower must be no more than 45 characters in length.")
